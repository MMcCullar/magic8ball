...
//Function to store question as variable
function question() {
    document.querySelector('#question').innerHTML = '';
    let typedInput = input.value;
    const p = document.createElement('p');
    p.textContent = typedInput;
    document.querySelector('#question').appendChild(p);
}

//Function to select random Magic 8 Ball responses
function outcome() {   
...
function updateCanvas()
{
    ...
    ctx.fillStyle   = 'rgba(131, 142, 158, .0)';  
